...
## some hints on the task at hand
...
read_html("https://azimpremjiuniversity.edu.in/people") |> 
  html_elements("h3.title-h4.mb-0 a") |>
  html_text2()
```
...
read_html("https://azimpremjiuniversity.edu.in/people") |> 
  html_elements("h3.title-h4.mb-0") |> 
  html_element("a") |> 
  html_text2()
...
read_html("https://azimpremjiuniversity.edu.in/people") |> 
  html_elements('h4.font-medium + p') |>  
  html_text2()
...
read_html("https://azimpremjiuniversity.edu.in/people") |> 
  html_elements('[class="sm:w-4/12 sm:pl-4 mb-4 sm:mb-0 text-sm"]') |> html_element("p") |> 
  html_text2()
...
> Somethings need to be seen

# Your turn

# Important stuff I left out

1. Parallel Processing. [see1](https://www.oreilly.com/library/view/parallel-r/9781449317850/), [see2](https://tidyverse.org/blog/2025/07/purrr-1-1-0-parallel/), [see3](https://purrr.tidyverse.org/reference/in_parallel.html)
2. Ethical Scraping. [see](https://dmi3kno.github.io/polite/)


# Readings and resources

1. [Chapter 24 R4DS](https://r4ds.hadley.nz/webscraping.html)
2. [Rvest Documentaiotn](https://rvest.tidyverse.org/articles/rvest.html)
3. [Selenidir Documentation](https://ashbythorpe.github.io/selenider/articles/selenider.html)
4. [Web Scraping with R](https://steviep42.github.io/webscraping/book/)
